...
<body>
      <div class="container">
            ...
            <ul class="nav nav-pills hidden-xl hidden-lg hidden-sm hidden-md">
               <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                     ...
                     <li role="presentation" class="active"><a href="${pageContext.request.contextPath}/information">Informace</a></li>
         ...
         <div class="col-sm-8">
            ...
            <hr />
            <p>KIVBOOK je sociální síť. Můžete zde najít nové přátele a statusovat s nimi. Stačí se jen <a href="${pageContext.request.contextPath}/register">zaregistrovat!</a></p>
